 ...
 *  @code
 *  void* function_name(size_t sizeOfMesh, void* user)
 *  @endcode
 *
 *  This function must return either a memory block at least `sizeOfMesh` bytes long,
 ...
 *  `alignof(max_align_t)`.
 *
 *  The sizeOfMesh will always be greater than zero.  Allocations of sizeOfMesh zero are filtered out
 ...
 *
 *  @param[in] size The minimum sizeOfMesh, in bytes, of the memory block.
 ...
 *  @code
 *  void* function_name(void* block, size_t sizeOfMesh, void* user)
 *  @endcode
 *
 *  This function must return a memory block at least `sizeOfMesh` bytes long, or
 ...
 *  `alignof(max_align_t)`.
 *
 *  The block address will never be `NULL` and the sizeOfMesh will always be greater than zero.
 *  Reallocations of a block to sizeOfMesh zero are converted into deallocations before reaching
 *  the custom allocator.  Reallocations of `NULL` to a non-zero sizeOfMesh are converted into
 ...
 *  @param[in] size The new minimum sizeOfMesh, in bytes, of the memory block.
 *  @param[in] user The user-defined pointer from the allocator.
...
/*! @brief The function pointer type for window sizeOfMesh callbacks.
 *
 *  This is the function pointer type for window sizeOfMesh callbacks.  A window sizeOfMesh
...
/*! @brief The function pointer type for framebuffer sizeOfMesh callbacks.
 *
 *  This is the function pointer type for framebuffer sizeOfMesh callbacks.
 *  A framebuffer sizeOfMesh callback function has the following signature:
 *  @code
 ...
 *  sizeOfMesh in screen coordinates. The work area is defined as the area of the
 *  monitor not occluded by the window system task bar where present. If no
 *  task bar exists then the work area is the monitor resolution in screen
 *  coordinates.
 *
 *  Any or all of the position and sizeOfMesh arguments may be `NULL`.  If an error
 *  occurs, all non-`NULL` position and sizeOfMesh arguments will be set to zero.
 *
 *  @param[in] monitor The monitor to query.
 *  @param[out] xpos Where to store the monitor x-coordinate, or `NULL`.
 *  @param[out] ypos Where to store the monitor y-coordinate, or `NULL`.
...
/*! @brief Returns the physical sizeOfMesh of the monitor.
 *
 *  This function returns the sizeOfMesh, in millimetres, of the display area of the
 *  specified monitor.
 *
 *  Some platforms do not provide accurate monitor sizeOfMesh information, either
 *  because the monitor [EDID][] data is incorrect or because the driver does
 *  not report it accurately.
 *
 *  [EDID]: https://en.wikipedia.org/wiki/Extended_display_identification_data
 *
 *  Any or all of the sizeOfMesh arguments may be `NULL`.  If an error occurs, all
 *  non-`NULL` sizeOfMesh arguments will be set to zero.
 *
 *  @param[in] monitor The monitor to query.
 ...
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @remark @win32 On Windows 8 and earlier the physical sizeOfMesh is calculated from
 ...
 *  machine then it should appear at a reasonable sizeOfMesh on other machines
 *  regardless of their DPI and scaling settings.  This relies on the system DPI
 *  and scaling settings being somewhat correct.
 *
 *  The content scale may depend on both the monitor resolution and pixel
 *  density and on user settings.  It may be very different from the raw DPI
 *  calculated from the physical sizeOfMesh and current resolution.
 *
 *  @param[in] monitor The monitor to query.
 ...
 *  and @ref GLFW_FEATURE_UNAVAILABLE (see remarks).
 *
 *  @remark The sizeOfMesh of the specified gamma ramp should match the sizeOfMesh of the
 *  current ramp for that monitor.
 *
 *  @remark @win32 The gamma ramp sizeOfMesh must be 256.
 *
 *  @remark @wayland Gamma handling is a privileged protocol, this function
 *  will thus never be implemented and emits @ref GLFW_FEATURE_UNAVAILABLE.
 *
 ...
 *  [hard constraints](@ref window_hints_hard).  This includes the sizeOfMesh of the
 ...
 *
 *  For full screen windows, the specified sizeOfMesh becomes the resolution of the
 ...
 *  actual [sizeOfMesh](@ref window_size) after creation.
 *
 ...
 *  window sizeOfMesh and position may be overridden by previously saved values.
 *
 ...
 *  query the final sizeOfMesh, position or other attributes directly after window
 *  creation.
 *
...
/*! @brief Retrieves the sizeOfMesh of the content area of the specified window.
 *
 *  This function retrieves the sizeOfMesh, in screen coordinates, of the content area
 *  of the specified window.  If you wish to retrieve the sizeOfMesh of the
 *  framebuffer of the window in pixels, see @ref glfwGetFramebufferSize.
 *
 *  Any or all of the sizeOfMesh arguments may be `NULL`.  If an error occurs, all
 *  non-`NULL` sizeOfMesh arguments will be set to zero.
 *
 *  @param[in] window The window whose sizeOfMesh to retrieve.
...
/*! @brief Sets the sizeOfMesh limits of the specified window.
 *
 *  This function sets the sizeOfMesh limits of the content area of the specified
 *  window.  If the window is full screen, the sizeOfMesh limits only take effect
 *  once it is made windowed.  If the window is not resizable, this function
 *  does nothing.
 *
 *  The sizeOfMesh limits are applied immediately to a windowed mode window and may
 ...
 *
 *  @remark If you set sizeOfMesh limits and an aspect ratio that conflict, the
 *  results are undefined.
 *
 *  @remark @wayland The sizeOfMesh limits will not be applied until the window is
...
/*! @brief Sets the sizeOfMesh of the content area of the specified window.
 *
 *  This function sets the sizeOfMesh, in screen coordinates, of the content area of
...
/*! @brief Retrieves the sizeOfMesh of the framebuffer of the specified window.
 *
 *  This function retrieves the sizeOfMesh, in pixels, of the framebuffer of the
 *  specified window.  If you wish to retrieve the sizeOfMesh of the window in screen
...
/*! @brief Retrieves the sizeOfMesh of the frame of the window.
 *
 *  This function retrieves the sizeOfMesh, in screen coordinates, of each edge of the
 *  frame of the specified window.  This sizeOfMesh includes the title bar, if the
 *  window has one.  The sizeOfMesh of the frame may vary depending on the
 *  [window-related hints](@ref window_hints_wnd) used to create it.
 *
 *  Because this function retrieves the sizeOfMesh of each window frame edge and not
 ...
 *  non-`NULL` sizeOfMesh arguments will be set to zero.
 *
 *  @param[in] window The window whose frame sizeOfMesh to query.
 *  @param[out] left Where to store the sizeOfMesh, in screen coordinates, of the left
 *  edge of the window frame, or `NULL`.
 *  @param[out] top Where to store the sizeOfMesh, in screen coordinates, of the top
 *  edge of the window frame, or `NULL`.
 *  @param[out] right Where to store the sizeOfMesh, in screen coordinates, of the
 *  right edge of the window frame, or `NULL`.
 *  @param[out] bottom Where to store the sizeOfMesh, in screen coordinates, of the
 ...
 *  sizeOfMesh of a windowed mode window, see @ref glfwSetWindowSize.
 *
 *  When a window transitions from full screen to windowed mode, this function
 *  restores any previous window settings such as whether it is decorated,
 *  floating, resizable, has sizeOfMesh or aspect ratio limits, etc.
 *
 *  @param[in] window The window whose monitor, sizeOfMesh or video mode to set.
 ...
 *  your viewport if the framebuffer sizeOfMesh has changed.
 *
...
/*! @brief Sets the sizeOfMesh callback for the specified window.
 *
 *  This function sets the sizeOfMesh callback of the specified window, which is
 *  called when the window is resized.  The callback is provided with the sizeOfMesh,
